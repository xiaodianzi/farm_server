    ...
    var DateRangePicker = function(element, options, cb) {
        ...
        if (typeof options.template !== 'string' && !(options.template instanceof $))
            options.template  = '<div class="daterangepicker dropdown-menu">' +
                                '<form role="form" method="POST" action="/plansolve/manger/web/order/statisticalOrder">'+
                                    '<div class="ranges">' +
                                    '</div>' +
                                    ...
                                    '<div class="ranges ranges_1">' +
                                        '<div class="range_inputs">' +
                                            '<button class="applyBtn" disabled="disabled" style="background-color: #2196f3;border: none;" type="submit"></button> ' +
